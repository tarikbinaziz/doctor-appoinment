                ...
                children: [
                  ...
                  Expanded(
                    child: AppButton(
                      ...
                      enableScaleAnimation: false,
                      onTap: () {
                        PastPrescriptionHistoryScreen().launch(context);
                      },
                      shapeBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(6),
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(conditions[index],style: TextStyle(color: colors[index]),),
                                                ],),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text("Qty: 01",style: ksubTitleTextStyle,),
                                                  Text(condition[index],style: TextStyle(color: color[index]),),
                                                ],),
