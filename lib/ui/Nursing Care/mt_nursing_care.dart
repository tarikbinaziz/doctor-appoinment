...
import '../Ambulance/mt_book_ambulance.dart';
import 'mt_full_day_pack.dart';



class NursingCareScreen extends StatelessWidget {
  NursingCareScreen({Key? key}) : super(key: key);
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                              image: AssetImage("assets/images/nursing1.png"),fit: BoxFit.fill)),
                    ),
                    SizedBox(
                      width: 10,
                    ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: kSubTitleColor.withOpacity(0.1)),
                          image: const DecorationImage(
                              image: AssetImage("assets/images/nursing2.png"),fit: BoxFit.fill)),
                    ),
                    SizedBox(
                      width: 10,
                    ),
